...
Public Class rent_a_car2
    ...
    Private Sub RoundedButton5_Click(sender As Object, e As EventArgs) Handles RoundedButton5.Click
        ...
        Dim dailyPrice As Decimal = Convert.ToDecimal(SelectedCar(11)) ' Assuming daily price is at index 11
        Dim totalPrice As Decimal = dailyPrice * differenceInDays

        ' Display a success message with the total price
        If RadioButton1.Checked Then
            ...
            SelectedCar(12) = False ' Assuming availability is at index 12

            ' Update the UI to reflect the car's unavailability
